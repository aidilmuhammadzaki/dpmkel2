...
const SelectAPlan = () => {
  ...
  return (
    <View style={styles.selectAPlan}>
      ...
      />
      <Text style={styles.saveMoreWith}>
        Save more with exclusive membership.
      </Text>
      <Text style={styles.selectAPlan1}>Select a Plan</Text>
      <View style={styles.rectangleParent}>
        <View style={styles.groupChild} />
        <View style={styles.buyMembershipWrapper}>
          <Text style={styles.buyMembership}>Buy Membership</Text>
        </View>
      </View>
      ...
      <Text style={[styles.rp800000, styles.rp800000Typo]}>Rp. 800.000</Text>
      <Text style={[styles.rp2000000, styles.rp800000Typo]}>Rp. 2.000,000</Text>
      <Text style={[styles.rp3000000, styles.rp800000Typo]}>Rp. 3.000,000</Text>
